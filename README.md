...
y al mismo tiempo fortalecer mi base en **redes** para avanzar hacia el área de  
...
| Área | Tecnologías |
|------|--------------|
| Web | HTML, CSS, JavaScript (básico), Supabase |
| Móvil | Android Studio (Kotlin / Java) |
| Programación | C++, C, Java |
| Control de versiones | Git, GitHub |
 
**Redes y Ciberseguridad ofensiva**
 
| Área | Tecnologías |
|------|--------------|
| Redes | VLANs, DHCP, Routing, Subnetting |
| Reconocimiento | Nmap, ffuf, gobuster, SecLists, DNSrecon, Sublist3r |
| Explotación | Metasploit, Burp Suite |
| Sistemas | Linux, Wireshark |
| En preparación | eJPT v2 |
...
**Ratatube**  
Proyecto experimental que realiza descargas de video y audio de YouTube.  
